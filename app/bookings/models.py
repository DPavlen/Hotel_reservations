...
class Bookings(Base):
    ...
    Бронирование (Bookings) принадлежит определенному пользователю (users), many to one.
    Бронирование (Bookings) относится к определенному номеру (Rooms), many to one. """
